...
setTimeout(() => {
  app
    .querySelector<HTMLButtonElement>("#startCamera")!
  ...
  app
    .querySelector<HTMLButtonElement>("#cameraCapture")!
    .addEventListener("click", async () => {
      try {
  ...
  app
    .querySelector<HTMLButtonElement>("#flipCamera")!
    .addEventListener("click", async () => {
      try {
  ...
  app
    .querySelector<HTMLButtonElement>("#stopCamera")!
    .addEventListener("click", async () => {
      try {
  ...
  app
    .querySelector<HTMLButtonElement>("#cameraRecord")!
    .addEventListener("click", async () => {
      try {
  ...
  app
    .querySelector<HTMLButtonElement>("#stopRecord")!
    .addEventListener("click", async () => {
      try {
  ...
  app
    .querySelector<HTMLButtonElement>("#getSupportedFlashModes")!
    .addEventListener("click", async () => {
      try {
  ...
  app
    .querySelector<HTMLButtonElement>("#getHorizontalFov")!
    .addEventListener("click", async () => {
      try {
  ...
  app
    .querySelector<HTMLButtonElement>("#setFlashMode")!
    .addEventListener("click", async () => {
      try {
        ...
        if (flashModes.length > 0) {
          ...
          currentFlashModeIndex =
            (currentFlashModeIndex + 1) % flashModes.length;
        } else {
