...
@CapacitorPlugin(name = "CameraPreview", permissions = {
    @Permission(strings = { CAMERA, RECORD_AUDIO }, alias = CameraPreview.CAMERA_PERMISSION_ALIAS),
})
public class CameraPreview
    extends Plugin
    implements KNewCameraActivity.CameraPreviewListener {
  ...
  public void start(PluginCall call) {
    if (PermissionState.GRANTED.equals(
  ...
  private void startCamera(final PluginCall call) {
    ...
    fragment.setDefaultCamera(
        position.equals("front") ? CameraSelector.DEFAULT_FRONT_CAMERA : CameraSelector.DEFAULT_BACK_CAMERA);
